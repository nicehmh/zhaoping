        ...
        <div class="nav-collapse sidebar-nav">
          <ul class="nav nav-tabs nav-stacked main-menu">                      
             ...
             <div class="right content">
              ...
              <td style="text-align:center;"><a class="btn btn-xs btn-info right right-d2" href="/index.php/Admin/Xmanager/test?filename=<?php echo ($list["file"]); ?>&username=<?php echo ($list["name"]); ?>" ><i class="icon-edit">查看附件</i></a>   
            <?php } ?>   
               </div>
             </div>      
             </div>      
