<?php if (!defined('THINK_PATH')) exit();?><!-- 人才招聘 -->
<!DOCTYPE html>
<html lang="en">
<head>
          ...
          <ul class="nav nav-tabs nav-stacked main-menu">
             ...
             <div class="right content">
                <div class="right-menu">
                  <p class="left"><i class="fa1 icon-home"></i>首页<i class="fa icon-angle-right"></i>人才招聘</p>
                ...
                <form action="/index.php/Admin/Smanager/record?zd=sqsj" method="POST" name="jaj">
