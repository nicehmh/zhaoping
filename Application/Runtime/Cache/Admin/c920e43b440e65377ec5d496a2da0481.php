            ...
            <li><a href="/zhaopin/index.php/admin/Xexpert/index.html">&nbsp&nbsp&nbsp&nbsp<i class="fa icon-angle-right"></i><span>已评审</span></a></li>
             ...
             <div class="right content">
                <div class="right-menu">
                	<p class="left"><i class="fa1 icon-home"></i>首页<i class="fa icon-angle-right"></i>已取消</p>
                ...
                <div class="panel panel-default">
					 ...
					 <table class="table table-bordered table-striped border">
								...
								<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
								   ...
								   <td style="text-align:center;"><a href="/zhaopin/index.php/Admin/Xexpert/hl?numid=<?php echo ($list["numid"]); ?>&aid=<?php echo ($list["aid"]); ?>"  class="btn btn-sm btn-info " ><i class="icon-pencil">评审</i></a>
								   </td>
