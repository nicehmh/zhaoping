          ...
          <ul class="nav nav-tabs nav-stacked main-menu">
             ...
             <div class="right content">
                <div class="right-menu">
                	<p class="left"><i class="fa1 icon-home"></i>首页<i class="fa icon-angle-right"></i>联系方式</p>
                ...
                <form action="/zhaopin/index.php/Admin/Smanager/record?zd=lxfs" method="POST" name="jaj">
