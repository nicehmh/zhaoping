...
<script type="text/javascript">
  function f1(){
     ...
     //window.location.href="/index.php/Admin/Ymanager/rcexpert?user="+con1+"&password="+con2+"&name="+con3+"&college="+con4+"&work_area="+con5+"&kp1="+con6+"&kp2="+con7+"&kp3="+con8;
      var xhr=new XMLHttpRequest();
	  xhr.onreadystatechange=function(){
	      if(xhr.readyState==4){
		      alert(xhr.responseText);
			  window.location.href="/index.php/Admin/Ymanager/add";
		  }
	  }
	  xhr.open('get',"/index.php/Admin/Ymanager/rcexpert?user="+con1+"&password="+con2+"&name="+con3+"&college="+con4+"&work_area="+con5+"&kp1="+con6+"&kp2="+con7+"&kp3="+con8);
	  xhr.send(null);
  }
  function f2(pid){
      var xhr=new XMLHttpRequest();
	  ...
	  xhr.open('get',"/index.php/Admin/Ymanager/delexpert?id="+pid);
	  xhr.send(null);
  }
</script>
