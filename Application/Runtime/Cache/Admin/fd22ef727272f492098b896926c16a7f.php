		  ...
		  xhr.onreadystatechange=function(){
		       if(xhr.readyState==4){
			      ...
			      if(xhr.responseText=="2"){
				       ...
				       alert("提交失败，请重试");
				       //window.location.href="/index.php/Admin/Ymanager/shouye";
				  }
			   }
		  }
		  xhr.open("post","/index.php/Admin/Ymanager/record?zhangtai="+state);
                ...
                <div class="panel panel-default ">
                     <div class="panel-heading">
					      <h3 class="panel-title">
					         ...
					         申请表			
<a class="right right-d2"  style="color:blue;" href="/index.php/Admin/Ymanager/handout">返回</a>							 
					      </h3>
					 </div>
