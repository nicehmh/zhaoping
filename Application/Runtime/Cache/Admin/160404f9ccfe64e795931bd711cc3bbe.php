                ...
                <div class="panel panel-default">
                     <div class="panel-heading">
					      <h3 class="panel-title">
					         ...
					         个人中心<b style="font-size:11px;">>>已评申请表</b>		          
					      </h3>
					 </div>
					   ...
					   <table class="table table-bordered table-striped border">
								  ...
								  <tr>
								   ...
								   <td style="text-align:center;"><a class="btn btn-xs btn-info" href="/index.php/admin/Xmanager/look.html?numid=<?php echo ($vo["numid"]); ?>" ><i class="icon-edit">查看</i></a>
								  <!-- <a class="btn btn-xs  btn-success " href=""><i class="icon-trash">转发</i></a>-->
								   <a class="btn btn-xs btn-danger" href="/index.php/Admin/Xmanager/del?numid=<?php echo ($vo["numid"]); ?>"><i class="icon-trash">删除</i></a>
								   <a class="btn btn-xs btn-primary" href="/index.php/Admin/Xmanager/replay?aid=<?php echo ($vo["aid"]); ?>"><i class="icon-comment-alt">回复</i></a>
                                  </td>									   
                                                                 </tr>								   
						         <!-- <td>
								...
								<?php $str=array_keys($vo); foreach($str as $st){ $strem=strpos($st,'#a'); if(empty($strem)){}else{ ?>
												     <li role="presentation" >
                                                                                                        <a role="menuitem" tabindex="-1" href="#"><?php echo "评价人".$vo[$st]['name']; ?></a>
                                                                                                    </li>
											<?php } } ?>
									 </php>
									...
									<?php $str=array_keys($vo); foreach($str as $st){ $strem=strpos($st,'#b'); if(empty($strem)){}else{ ?>
												     <li role="presentation" >
                                                                                                        <a role="menuitem" tabindex="-1" href="/index.php/Admin/Xmanager/hl1"><?php echo $vo[$st]['name']."  "."评分：".$klp[$vo['aid']][$vo[$st]['pid']]; ?></a>
                                                                                                    </li>
											<?php } } ?>
                      
									 <li role="presentation" class="divider"></li>
                                    <li role="presentation" class="dropdown-header">不推荐</li>
								<?php $str=array_keys($vo); foreach($str as $st){ $strem=strpos($st,'#c'); if(empty($strem)){}else{ ?>
												     <li role="presentation" >
                                                                                                        <a role="menuitem" tabindex="-1" href="#"><?php echo $vo[$st]['name']; ?></a>
                                                                                                    </li>
											<?php } } ?>
