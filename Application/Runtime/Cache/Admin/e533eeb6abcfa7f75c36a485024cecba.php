...
function selectAll(){
 ...
 function f1(){
	  ...
	  var ad=document.getElementById("ad").value;
       ...
       // alert(allValues);
       //window.location.href="/zhaopin/index.php/Admin/Ymanager/xzj?all="+allValues+"&pid="+ex;
        var xhr = new XMLHttpRequest();
	xhr.onreadystatechange=function(){
	     if(xhr.readyState==4){
	        alert(xhr.responseText);
		window.location.href="/zhaopin/index.php/Admin/Ymanager/handout";
	     }
	}
	xhr.open('get',"/zhaopin/index.php/Admin/Ymanager/xzj?all="+allValues+"&pid="+ex+"&id="+ad);
	xhr.send(null);
    }
</script>
                ...
                <div class="panel panel-default">
                     <div class="panel-heading">
					      <h3 class="panel-title">
					         ...
					         个人中心<b style="font-size:11px;">>>个人已评申请表</b>	
<a class="right right-d2"  style="color:blue;" href="/zhaopin/index.php/Admin/Ymanager/index"><span style="font-size:14px;color:#333;">转换到>> </span>专家已评申请表</a>								 
					      </h3>
					 </div>
					   ...
					   <table class="table table-bordered table-striped border">
								  ...
								  <tr>
								   ...
								   <td style="text-align:center;"><a class="btn btn-xs btn-info" href="/zhaopin/index.php/Admin/Ymanager/hl1?tid=<?php echo ($vo["kp2"]); ?>" ><i class="icon-edit">查看</i></a>
