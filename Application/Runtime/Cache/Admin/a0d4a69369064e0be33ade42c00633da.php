...
<div class="footer">
    ...
    function f1(num){
		...
		if(s2<s1){
		//window.location.href="/zhaopin/index.php/Admin/Ymanager/restate?state="+state+"&aid=<?php echo ($aid); ?>";
		    var xhr=new XMLHttpRequest();
	        xhr.onreadystatechange=function(){
	         if(xhr.readyState==4){
		      alert(xhr.responseText);
			  window.location.href="/zhaopin/index.php/Admin/Ymanager/replay?aid=<?php echo ($_SESSION['aid']); ?>";
		     }
	        }
	        xhr.open('get',"/zhaopin/index.php/Admin/Ymanager/restate?state="+state+"&aid=<?php echo ($aid); ?>");
	        xhr.send(null);
		}else{
		    alert("您已回复过");
		}
	...
	function f2(){
	   ...
	   xhr.open('get',"/zhaopin/index.php/Admin/Ymanager/send_con?ModalLabel="+ModalLabel);
	   xhr.send(null);
	}
    </script>